<template>
  <div>
    <header class="container-fluid flexed bgarticle">
      <h2 class="text-light">Te presentamos la nueva chevrolet Blazer</h2>
      <h4 class="text-light">Llega como la primera SUV deportiva de la marca</h4>
    </header>
      ...
      <div class="row">
        <div class="col flexed">
          <p>
            ...
            conocido nombre de la marca, la Blazer, que ahora llega con mucha
            más cercanía al diseño y concepto del Camaro que el del todo terreno
            rudo que fue hace años atrás.
          </p>
          <p>
            ...
            <img class="my-5" src="https://chevrolettepic.com/wp-content/uploads/2020/06/241520450_5975945512475666_2065417374678301410_n.jpeg" alt="">
            <h2 class="my-2"><strong>DISEÑO DEPORTIVO</strong></h2>
            <p>
